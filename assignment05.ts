...
let personName = "\tAbdullah/tYaqoob\t" ;
let stripped = "\nline 1\nline 2\nline 3\nline 4"
...
// Example 01
let personName : string = "\tAbdullah/tYaqoob\t" ; // this variable add space at the start ,middle and end of person's name 
...
previousLiGuests.push("Abdullah Yaqoob")
console.log(previousLiGuests);
...
let testStatement1 : string = "Abdullah Yaqoob" ;
...
let testStatement2 : string = "Abdullah" ;
console.log("I predict false");
...
if(userName.includes("Yaqoob") || userName.includes("butt")){
  console.log(true);
